        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    _a = jwt.verify(token, config_1.default.jwtSecret), id = _a.id, email = _a.email;
                    return [4 /*yield*/, user_1.default.findOne({ "_id": id })];
                case 2:
                    usr = _b.sent();
                    usr.password = "password-hidden";
                    return [2 /*return*/, [true, usr]];
                case 3:
                    error_1 = _b.sent();
                    console.log("JWT Helper--> CheckJWT: ", error_1);
